...
<text class="ciba-tx ciba-fb" x="93" y="28" text-anchor="middle" font-size="11" font-weight="600">利用デバイス</text>
<text class="ciba-tx ciba-fb ciba-muted" x="93" y="42" text-anchor="middle" font-size="10">（POS 端末）</text>
...
<text class="ciba-tx ciba-fb ciba-sec-f" x="680" y="28" text-anchor="middle" font-size="11" font-weight="600">認証デバイス</text>
<text class="ciba-tx ciba-fb ciba-muted" x="680" y="42" text-anchor="middle" font-size="10">（スタッフのスマホ）</text>
...
<text class="ciba-tx ciba-fb ciba-sec-f" x="555" y="160" text-anchor="middle" font-size="10">Acme Coffee で 800 円を承認?</text>
...
<text class="ciba-tx ciba-fb ciba-muted" x="54" y="247" font-size="9.5">loop · interval 秒ごとに poll</text>
...
<text class="ciba-tx ciba-fb ciba-muted" x="555" y="333" text-anchor="middle" font-size="10">ユーザがスマホで承認</text>
...
<text class="ciba-tx ciba-fb ciba-muted" x="284" y="396" font-size="10">（次の poll）</text>
